// Data wilayah administratif Indonesia: provinsi → daftar kota/kabupaten.
// Dipakai untuk dropdown berjenjang (kota hanya bisa dipilih setelah provinsi).
// Sumber: pembagian administratif 38 provinsi (mencakup 4 provinsi baru di Papua).
...
export const PROVINCES_CITIES = {
  ...
  'Sumatera Utara': [
    ...
    'Kabupaten Toba', 'Kota Binjai', 'Kota Gunungsitoli', 'Kota Medan', 'Kota Padang Sidempuan',
  ...
  'Sumatera Barat': [
    ...
    'Kota Bukittinggi', 'Kota Padang', 'Kota Padang Panjang', 'Kota Pariaman', 'Kota Payakumbuh',
  ...
  'DKI Jakarta': [
    'Kabupaten Administrasi Kepulauan Seribu', 'Kota Administrasi Jakarta Barat', 'Kota Administrasi Jakarta Pusat',
  ...
  'Jawa Barat': [
    ...
    'Kabupaten Subang', 'Kabupaten Sukabumi', 'Kabupaten Sumedang', 'Kabupaten Tasikmalaya', 'Kota Bandung',
    'Kota Banjar', 'Kota Bekasi', 'Kota Bogor', 'Kota Cimahi', 'Kota Cirebon', 'Kota Depok', 'Kota Sukabumi',
    'Kota Tasikmalaya',
  ],
  'Jawa Tengah': [
  ...
  'Banten': [
    'Kabupaten Lebak', 'Kabupaten Pandeglang', 'Kabupaten Serang', 'Kabupaten Tangerang', 'Kota Cilegon',
  ...
  'Bali': [
    ...
    'Kabupaten Karangasem', 'Kabupaten Klungkung', 'Kabupaten Tabanan', 'Kota Denpasar',
  ],
  'Nusa Tenggara Barat': [
    'Kabupaten Bima', 'Kabupaten Dompu', 'Kabupaten Lombok Barat', 'Kabupaten Lombok Tengah', 'Kabupaten Lombok Timur',
    'Kabupaten Lombok Utara', 'Kabupaten Sumbawa', 'Kabupaten Sumbawa Barat', 'Kota Bima', 'Kota Mataram',
  ],
  'Nusa Tenggara Timur': [
  ...
  'Sulawesi Selatan': [
    ...
    'Kabupaten Tana Toraja', 'Kabupaten Toraja Utara', 'Kabupaten Wajo', 'Kota Makassar', 'Kota Palopo',
    'Kota Parepare',
  ],
  'Sulawesi Tenggara': [
    'Kabupaten Bombana', 'Kabupaten Buton', 'Kabupaten Buton Selatan', 'Kabupaten Buton Tengah', 'Kabupaten Buton Utara',
    'Kabupaten Kolaka', 'Kabupaten Kolaka Timur', 'Kabupaten Kolaka Utara', 'Kabupaten Konawe',
    'Kabupaten Konawe Kepulauan', 'Kabupaten Konawe Selatan', 'Kabupaten Konawe Utara', 'Kabupaten Muna',
  ...
  'Sulawesi Barat': [
    'Kabupaten Majene', 'Kabupaten Mamasa', 'Kabupaten Mamuju', 'Kabupaten Mamuju Tengah', 'Kabupaten Pasangkayu',
  ...
  'Maluku Utara': [
    'Kabupaten Halmahera Barat', 'Kabupaten Halmahera Selatan', 'Kabupaten Halmahera Tengah', 'Kabupaten Halmahera Timur',
  ...
  'Papua Tengah': [
    'Kabupaten Deiyai', 'Kabupaten Dogiyai', 'Kabupaten Intan Jaya', 'Kabupaten Mimika', 'Kabupaten Nabire',
    'Kabupaten Paniai', 'Kabupaten Puncak', 'Kabupaten Puncak Jaya',
  ],
  'Papua Pegunungan': [
...
// Daftar kota/kabupaten untuk sebuah provinsi (kosong bila provinsi tak dikenal).
export function citiesOf(province) {
  return PROVINCES_CITIES[province] || []
}
